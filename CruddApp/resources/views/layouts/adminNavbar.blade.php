  ...
  <div class="flex w-full flex-wrap items-center justify-between px-3">
    ...
    <div
      ...
      <ul
        ...
        <li class="mb-4 lg:mb-0 lg:pe-2" data-twe-nav-item-ref>
          <a
            class="text-red/60 transition duration-200 hover:text-red/80 hover:ease-in-out focus:text-red/80 active:text-red/80 motion-reduce:transition-none dark:text-white/60 dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80 lg:px-2"
            href="/logout"
            data-twe-nav-link-ref
            >Logout</a
          >
